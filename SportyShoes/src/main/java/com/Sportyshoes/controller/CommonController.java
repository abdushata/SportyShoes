...
import com.Sportyshoes.service.OrdersService;
...
public class CommonController {
	...
	public String selectedShoeInfotMethod(ModelMap model, @RequestParam int id) {
		...
		try {
			...
			System.out.println(
					"Exception at com.Sportyshoes.controllers.CommonController.selectedShoeInfotMethod(HttpServletRequest, HttpServletResponse) "
							+ e.getMessage());
			return "selectedShoeInfoForm";
		}
	...
	public String orderInforMethod(ModelMap model, @RequestParam int id, @RequestParam String name,
		...
		try {
			...
			System.out.println(
					"Exception at com.Sportyshoes.controllers.CommonController.orderInforMethod(HttpServletRequest, HttpServletResponse) "
							+ e.getMessage());
			return "bookShoeForm";
		}
	...
	public String bookAndPaymentreturntoHomeMethod(ModelMap model, @RequestParam(name = "id") int shoeid,
		...
		try {
			...
			System.out.println(
					"Exception at com.Sportyshoes.controllers.CommonController.bookAndPaymentreturntoHomeMethod(HttpServletRequest, HttpServletResponse) "
							+ e.getMessage());
			return "orderplaceForm";
		}
	}
	...
	public String adminSigninMethod(ModelMap model, @RequestParam String username, @RequestParam String password) {
		...
		try {
			...
			System.out.println(
					"Exception at com.Sportyshoes.controllers.CommonController.signinMethod(HttpServletRequest, HttpServletResponse) "
							+ e.getMessage());
	...
	public String getcompletemenshoesforAdmin(ModelMap model) {
		...
		try {
			...
			System.out.println("Exception at com.Sportyshoes.controllers.CommonController.getcompletemenshoesforAdmin() "
					+ e.getMessage());
			return "adminForm";
		}
	...
	public String getcompletewomenshoesforAdmin(ModelMap model) {
		...
		try {
			...
			System.out.println("Exception at com.Sportyshoes.controllers.CommonController.getcompletewomenshoesforAdmin() "
					+ e.getMessage());
			return "adminForm";
		}
	...
	public String getcompletekidshoesforAdmin(ModelMap model) {
		...
		try {
			...
			System.out.println("Exception at com.Sportyshoes.controllers.CommonController.getcompletekidshoesforAdmin() "
					+ e.getMessage());
			return "adminForm";
		}
	}
	...
	public String customersListMethod(ModelMap model) {
		...
		try {
			...
			System.out.println(
					"Exception at com.Sportyshoes.controllers.CommonController.customersListMethod(HttpServletRequest, HttpServletResponse) "
							+ e.getMessage());
			return "customersListForm";
		}
	...
	public String reportsMethod(ModelMap model) {
		...
		try {
			...
			System.out.println("Exception at com.Sportyshoes.controllers.CommonController.reportsMethod() " + e.getMessage());
			return "reportsForm";
		}
	}
	...
	public String changeadminPasswordMethod(ModelMap model, @RequestParam String currentpassword,
		...
		try {
			...
			System.out.println(
					"Exception at com.Sportyshoes.controllers.CommonController.changeadminPasswordMethod(HttpServletRequest, HttpServletResponse) "
							+ e.getMessage());
			return "changeAdminPasswordForm";
		}
	...
	public String requiredReportsMethod(ModelMap model, @RequestParam String categeory, @RequestParam String date) {
		...
		try {
			...
			System.out.println(
					"Exception at com.Sportyshoes.controllers.CommonController.requiredReportsMethod() " + e.getMessage());
			return "reportsForm";
		}
	}
	...
	public String addNewProductMethod(ModelMap model, @RequestParam String weartype, @RequestParam String prod_name,
		...
		try {
			...
			System.out.println(
					"Exception at com.Sportyshoes.controllers.CommonController.addNewProducttMethod(HttpServletRequest, HttpServletResponse) "
							+ e.getMessage());
			return "adminForm";
		}
	...
	public String sigUpNewUserMethod(ModelMap model, @RequestParam String firstname, @RequestParam String lastname,
		...
		try {
			...
			if (roll.equals("admin")) {
				rollid = 1;
				UserInfoModel userInfoModel = userservice.isValidAdminUserService(firstname, password);
				if (userInfoModel != null) {
					model.put("errorMessage", "First Name and Password combination already exists");
					return "signUpForm";
				}
			} else {
				rollid = 2;
			...
			System.out.println(
					"Exception at com.Sportyshoes.controllers.CommonController.sigUpNewUserMethod(HttpServletRequest, HttpServletResponse) "
							+ e.getMessage());
			return "testErrorForm";
		}
	...
	public String deleteProductMethod(ModelMap model, @RequestParam int id) {
		...
		try {
			...
			System.out.println(
					"Exception at com.Sportyshoes.controllers.CommonController.deleteProductMethod() " + e.getMessage());
			return "adminForm";
		}
	}
